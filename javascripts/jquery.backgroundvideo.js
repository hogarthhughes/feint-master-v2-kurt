...
(function($) {
  ...
  $.backgroundVideo = function(el, options) {
    ...
    var buildVideo = function () {
      ...
      html += 'style="display:block;position:fixed;top:0;left:0;bottom:0;right:0;z-index:-100;width:100%;height:100%;">';
      ...
      plugin.videoEl = document.getElementsByClassName(plugin.settings.videoclass);
